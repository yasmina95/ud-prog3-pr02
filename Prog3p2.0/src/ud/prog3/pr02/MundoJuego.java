...
public class MundoJuego {
	...
	public static void aplicarFuerza( double fuerza, Coche coche ) {    
		double fuerzaRozamiento = Coche.calcFuerzaRozamiento( Coche.masa ,Coche.coefRozSuelo, Coche.coefRozAire, coche.getVelocidad() ); 
	  double aceleracion = Coche.calcAceleracionConFuerza( fuerza+fuerzaRozamiento, Coche.masa );  
